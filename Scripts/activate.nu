...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'F:\Python Program\data-structure-and-algorithm'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'F:\Python Program\data-structure-and-algorithm\Scripts\deactivate.nu'
